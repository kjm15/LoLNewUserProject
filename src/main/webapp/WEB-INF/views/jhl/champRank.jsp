						...
						<div class="rankTableBox">
							<div class="rankLine">
								<div class="rankSearch ranklineBtn">
									<span id = "Top" class="rankLineSelect" onclick="champRank('Top')"><img
										src="/img/jhl/positionImg/Position_Plat-Top.png">탑</span>
								</div>
								<div class="rankSearch">
									<span id = "jug" class="rankLineSelect" onclick="champRank('jug')"><img
										src="/img/jhl/positionImg/Position_Plat-Jungle.png">정글</span>
								</div>
								<div class="rankSearch">
									<span id = "mid" class="rankLineSelect" onclick="champRank('mid')"><img
										src="/img/jhl/positionImg/Position_Plat-Mid.png">미들</span>
								</div>
								<div class="rankSearch">
									<span id = "adc" class="rankLineSelect" onclick="champRank('adc')"><img
										src="/img/jhl/positionImg/Position_Plat-Bot.png">바텀</span>
								</div>
								<div class="rankSearch">
									<span id = "sup" class="rankLineSelect" onclick="champRank('sup')"><img
